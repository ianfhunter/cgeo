...
public class EmojiUtils {
    ...
    private static final EmojiSet[] symbols = {
            ...
            // letters
            new EmojiSet(0x24B6, new int[]{
                    /* circled n. */    0x24B6, 0x24B7, 0x24B8, 0x24B9, 0x24BA, 0x24BB, 0x24BC, 0x24BD, 0x24BE, 0x24BF, 0x24C0, 0x24C1, 0x24C2, 0x24C3, 0x24C4, 0x24C5, 0x24C6, 0x24C7, 0x24C8, 0x24C9, 0x24CA, 0x24CB, 0x24CC, 0x24CD, 0x24CE, 0x24CF
            }),
    };
